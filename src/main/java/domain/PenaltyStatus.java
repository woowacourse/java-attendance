...
public enum PenaltyStatus {
    ...
    public static PenaltyStatus findStatusByNickname(Nickname nickname, Attendances attendances) {
    ...
    public static int getTotalAbsentCount(Nickname nickname, Attendances attendances) {
