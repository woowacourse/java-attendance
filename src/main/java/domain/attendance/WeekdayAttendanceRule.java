...
public class WeekdayAttendanceRule implements AttendanceRule {

    private static final int WEEKDAY_HOUR_LIMIT = 10;
    ...
    static {
        ...
        STATUS.put(AttendanceStatus.TARDINESS,
                List.of(CampusTime.of(WEEKDAY_HOUR_LIMIT, TARDINESS_LIMIT),
                        CampusTime.of(WEEKDAY_HOUR_LIMIT, ABSENCE_LIMIT + 1)));
        STATUS.put(AttendanceStatus.ABSENCE,
                List.of(CampusTime.of(WEEKDAY_HOUR_LIMIT, ABSENCE_LIMIT), CampusTime.endTime()));
    }
