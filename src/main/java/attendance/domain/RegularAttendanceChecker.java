...
public class RegularAttendanceChecker implements AttendanceChecker {

    @Override
    public void checkCampusHour(final int hour, final int minute) {
    ...
    @Override
    public void validateCampusDay(final int day) {
    ...
    @Override
    public boolean isCampusDay(final int day) {
        LocalDate localDate = LocalDate.of(2024, 12, day);
        DayOfWeek dayOfWeek = localDate.getDayOfWeek();
