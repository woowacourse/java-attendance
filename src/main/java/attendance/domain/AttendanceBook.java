...
public class AttendanceBook {
    ...
    private List<Map.Entry<Crew, AttendanceStatus>> sortAttendanceStatuses(
        Map<Crew, AttendanceStatus> crewAttendanceStatuses) {
    ...
    private int compareAttendanceStatus(Map.Entry<Crew, AttendanceStatus> entry1,
                                        Map.Entry<Crew, AttendanceStatus> entry2) {
