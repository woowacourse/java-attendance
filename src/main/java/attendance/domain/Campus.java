...
public class Campus {
    ...
    private static final String IS_OFF_DAY_ERROR = "[ERROR] 12월 %d일 %s은 등교일이 아닙니다.";
    ...
    public static void validateOperationDay(final LocalDateTime attendance) {
        if (isOffDay(attendance)) {
