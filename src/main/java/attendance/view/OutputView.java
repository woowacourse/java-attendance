...
public class OutputView {
    ...
    private static final String REQUEST_NICKNAME = "닉네임을 입력해 주세요.";
    private static final String REQUEST_ATTENDANCE_MODIFY_NICKNAME = "출석을 수정하려는 크루의 닉네임을 입력해 주세요.";
    private static final String REQUEST_ATTENDANCE_TIME = "등교 시간을 입력해 주세요.";
    private static final String REQUEST_ATTENDANCE_MODIFY_DATE = "수정하려는 날짜(일)를 입력해 주세요.";
    private static final String REQUEST_ATTENDANCE_MODIFY_TIME = "언제로 변경하겠습니까?";
