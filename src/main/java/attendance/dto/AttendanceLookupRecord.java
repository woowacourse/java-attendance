...
public record AttendanceLookupRecord(String crewName, int month, int day, String dayOfWeek, String attendanceTime,
                                     String attendanceType) {
    private static final String TIME_FORMAT = "HH:mm";

    public static AttendanceLookupRecord fromCrewAttendance(Attendance attendance) {
        String crewName = attendance.getCrewName();
        ...
        return new AttendanceLookupRecord(crewName, month, day, dayOfWeek, attendanceTime, attendanceType);
    }
}
