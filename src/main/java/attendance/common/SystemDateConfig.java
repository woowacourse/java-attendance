...
public final class SystemDateConfig {
    ...
    public static final LocalDate SYSTEM_NOW_DATE = LocalDate.now().minusMonths(2);
    public static final LocalDateTime SYSTEM_NOW_DATETIME = LocalDateTime.now().minusMonths(2);
