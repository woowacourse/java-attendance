...
public final class SystemDateConfig {
    ...
    public static final LocalDate NOW_DATE = LocalDate.now().minusMonths(2);
    public static final LocalDateTime NOW_DATETIME = LocalDateTime.now().minusMonths(2);
