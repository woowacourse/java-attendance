...
public enum FeatureOption {
    ...
    FeatureOption(String option, String name) {
        this.option = option;
        this.name = name;
    }
    ...
    public static FeatureOption getFunction(String input) {
        return Arrays.stream(FeatureOption.values())
                .filter(featureOption -> Objects.equals(featureOption.option, input))
                .findAny()
