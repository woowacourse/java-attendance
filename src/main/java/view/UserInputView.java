...
public class UserInputView {
    ...
    public static String[] askAttendanceTimeForCheckAttendance() {
    ...
    public static int askDayForModifyAttendanceInfo() {
        System.out.println("수정하려는 날짜(일)를 입력해 주세요.");
        return Integer.parseInt(new Scanner(System.in).nextLine());
    }
    
    public static String[] askAttendanceTimeForModifyAttendance() {
