...
public class ViewMessage {
    public static final String PROMPT_TODAY = "오늘은 12월 몇일인가요? (예시) 1";
    ...
    public static final String ATTENDANCE = "%s %s %s (%s)";
    ...
    public static final String UPDATE_COMPLETE = "%s (%s) 수정 완료!";
    ...
    public static final String ABSENT_TIME_FORMAT = "--:--";
