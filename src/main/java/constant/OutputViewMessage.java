...
public enum OutputViewMessage {
    ...
    ATTENDANCE_SUCCESS_TYPE_RESPONSE("출석: %d회"),
    ATTENDANCE_BE_LATE_TYPE_RESPONSE("지각: %d회"),
    ATTENDANCE_ABSENCE_TYPE_RESPONSE("결석: %d회"),
    ATTENDANCE_PUNISHMENT_TYPE_RESPONSE("%s 대상자입니다."),

    ATTENDANCE_RISK_CREWS_HEADER("제적 위험자 조회 결과"),
    ATTENDANCE_RISK_CREWS_RESPONSE("- %s: 결석 %d회, 지각 %d회 (%s)"),
    ;
