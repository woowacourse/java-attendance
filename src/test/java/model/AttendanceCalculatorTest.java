...
class AttendanceCalculatorTest {
    ...
    void test1() {
        Assertions.assertThat(AttendanceCalculator.calculateAttendance(LocalDateTime.of(2024,12,2,13,0), LocalTime.of(13,0)))
    ...
    void test2() {
        Assertions.assertThat(AttendanceCalculator.calculateAttendance(LocalDateTime.of(2024,12,2,13,0), LocalTime.of(13,59)))
    ...
    void test3() {
        Assertions.assertThat(AttendanceCalculator.calculateAttendance(LocalDateTime.of(2024,12,2,13,0), LocalTime.of(13,6)))
                .isEqualTo(AttendanceStatus.LATE);
    }@Test
    @DisplayName("화요일과 시간을 받아 출석 판단하는 메서드 테스트")
    void test4() {
        Assertions.assertThat(AttendanceCalculator.calculateAttendance(LocalDateTime.of(2024,12,3,13,0), LocalTime.of(10,0)))
                .isEqualTo(AttendanceStatus.ATTENDANCE);
    }@Test
    @DisplayName("화요일과 시간을 받아 결석 판단하는 메서드 테스트")
    void test5() {
        Assertions.assertThat(AttendanceCalculator.calculateAttendance(LocalDateTime.of(2024,12,3,13,0), LocalTime.of(13,59)))
                .isEqualTo(AttendanceStatus.ABSENT);
    }@Test
    @DisplayName("화요일과 시간을 받아 지각을 판단하는 메서드 테스트")
    void test6() {
        Assertions.assertThat(AttendanceCalculator.calculateAttendance(LocalDateTime.of(2024,12,3,13,0), LocalTime.of(10,6)))
                .isEqualTo(AttendanceStatus.LATE);
    }@Test
