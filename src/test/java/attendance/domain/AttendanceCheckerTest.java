...
class AttendanceCheckerTest {
    ...
    @Test
    void test11() {
        assertThatThrownBy(() -> AttendanceChecker.isCampusDay(25))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    @Test
    void test12() {
        assertThatThrownBy(() -> AttendanceChecker.isCampusDay(22))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    @Test
    void test13() {
        assertThatCode(() -> AttendanceChecker.isCampusDay(24)).doesNotThrowAnyException();
    }
