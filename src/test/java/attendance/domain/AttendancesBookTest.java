...
public class AttendancesBookTest {
    ...
    void _12월14일_기준으로_빙티의_출석기록은_10개이다() {
        ...
        assertThat(attendancesBook.getByCrew(crew, localDate)).hasSize(10);
    }
    ...
    void 지각횟수와_결석횟수로_제적위험자를_판단한다(String nickName, Penalty expected) {
        ...
        LocalDate localDate = LocalDate.of(2024, 12, 14);
        int absenceCount = attendancesBook.countAttendanceStatus(crew, localDate, AttendanceStatus.ABSENCE);
        int lateCount = attendancesBook.countAttendanceStatus(crew, localDate, AttendanceStatus.LATE);
