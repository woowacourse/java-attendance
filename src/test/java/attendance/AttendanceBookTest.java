...
public class AttendanceBookTest {
    ...
    void 닉네임이_존재하지_않으면_예외를_던진다() {
        ...
        AttendanceBook attendanceBook = new AttendanceBook(Map.of("훌라", new Attendances(new ArrayList<>(attendances))));
    ...
    void 닉네임과_시간을_입력하면_출석한다() {
        List<LocalDateTime> attendances = List.of(LocalDateTime.of(2024, 12, 13, 9, 59));
        Map<String, Attendances> crewAttendances = Map.of("훌라", new Attendances(new ArrayList<>(attendances)));
