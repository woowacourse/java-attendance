...
//    private final FixedCustomClock fixedCustomClock = new FixedCustomClock(Set.of(LocalDate.of(2024, 12, 25)));
//
//    @BeforeEach
//    void setUp() {
//        crews = new Crews();
//        RawAttendanceStore rawAttendanceStore = new RawAttendanceStore();
//        loader = new CrewDataLoader(rawAttendanceStore); //12월 16일
//    }
//
//    @Test
