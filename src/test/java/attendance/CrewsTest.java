...
public class CrewsTest {
    ...
    void addByNicknameTest1() {
        ...
        assertThat(crews.add("모루")).isInstanceOf(Crew.class);
    }
    ...
    void addByNicknameTest2() {
        Crews crews = new Crews();
        crews.add("모루");
        assertThatThrownBy(() -> crews.add("모루")).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void getAttendanceUntilYesterdayTest1() {
        ...
        assertThat(crews.getCrewAttendanceUtilYesterday(today, "모루").size()).isEqualTo(2);
    }
    ...
    void getAttendanceUntilYesterdayTest2() {
        ...
        LocalDate today = LocalDate.of(2024,12,13);
        assertSoftly(softly -> {
            assertThat(crews.getCrewAttendanceUtilYesterday(today, "모루")).contains(new Attendance(LocalDateTime.of(2024,12,11,10,36)));
            assertThat(crews.getCrewAttendanceUtilYesterday(today, "모루")).contains(new Attendance(LocalDateTime.of(2024,12,12,10,6)));

            assertThat(crews.getCrewAttendanceUtilYesterday(today, "모루")).doesNotContain(new Attendance(LocalDateTime.of(2024,12,13,10,6)));
        });
    }
}
