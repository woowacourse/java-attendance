...
class AttendanceTimeTest {
    ...
    @Test
    @DisplayName("출석 시간으로부터 출석 상태 추출")
    void getAttendanceStatusAttendTest() {
        // given
        AttendanceTime attendanceTime = AttendanceTime.of(
    ...
    @Test
    @DisplayName("출석 시간으로부터 출석 상태 추출")
    void getAttendanceStatusLateTest() {
        // given
        ...
        // when
        AttendanceStatus attendanceStatus1 = attendanceTime1.toAttendanceStatus();
        AttendanceStatus attendanceStatus2 = attendanceTime1.toAttendanceStatus();
    ...
    @Test
    @DisplayName("출석 시간으로부터 출석 상태 추출")
    void getAttendanceStatusAbsenceTest() {
        // given
        AttendanceTime attendanceTime = AttendanceTime.of(
