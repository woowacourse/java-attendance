...
class AttendanceStatusTest {
    ...
    void should_return_ATTENDANT_attendance_status_by_attendance_record(String date, String time) {
        // given
    ...
    void should_return_LATE_attendance_status_by_attendance_record(String date, String time) {
        // given
        AttendanceRecord attendanceRecord = AttendanceRecord.of(date, time);
    ...
    void should_return_ABSENT_attendance_status_by_attendance_record(String date, String time) {
        // given
        AttendanceRecord attendanceRecord = AttendanceRecord.of(date, time);
