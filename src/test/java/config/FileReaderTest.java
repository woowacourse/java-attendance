...
public class FileReaderTest {
    ...
    public void validateFileReaderPolicyTest() {
        assertThatThrownBy(() -> new FileReader("attendances.csv"))
    ...
    public void readLinesTest() {
        assertThat(fileReader.readLines())
    ...
    public void validateFileFormatTest() {
        ...
        //when-then
        assertThatThrownBy(() -> fileReader.validateSplitLineFormat(splitLine))
    ...
    public void validateAttendanceDateTimeFormatTest() {
        ...
        //when-then
        assertThatThrownBy(() -> fileReader.parseAttendanceDateTime(attendanceDateTime))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    public void createAttendanceTest() {
        ...
        //when-then
        assertThat(fileReader.createAttendance(attendanceInfo))
    ...
    public void createAttendancesTest() {
        ...
        //when-then
        assertThat(fileReader.createAttendances(attendancesInfo))
